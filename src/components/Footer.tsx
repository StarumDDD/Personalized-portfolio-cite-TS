        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href={siteConfig.contact.social.github}
                target="_blank"
              ...
              <a
                href={siteConfig.contact.social.dribbble}
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 hover:text-primary transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/skills" className="text-gray-600 hover:text-primary transition-colors">
                  Skills
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start space-x-2">
                ...
                <span className="text-gray-600">{siteConfig.contact.location}</span>
              </li>
            </ul>
          </div>
        </div>
